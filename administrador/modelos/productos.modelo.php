...
class ModeloProductos{
	...
	static public function mdlSumaTotalProductosPrecio($tabla){

		$stmt = Conexion::conectar()->prepare("SELECT SUM(precio_venta * stock) as total FROM $tabla");
	...
	static public function mdlSumaTotalProductosCosto($tabla){
