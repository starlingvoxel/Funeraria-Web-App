...
class ControladorVentas{
	...
	static public function ctrCrearVenta(){
		...
		if(isset($_POST["nuevaVenta"])){
			...
			$tabla = "ventas";
			$fecha1 = $_POST["nuevaFechaVencimineto"];//"05/28/2019";;
			$fechaFormateada = date("Y-m-d", strtotime($fecha1));
			...
			$datos = array("id_vendedor"=>$_POST["idVendedor"],
						   ...
						   "total"=>$_POST["totalVenta"],
							 "comentario"=>$_POST["nuevoComentarioVenta"],
						   "metodo_pago"=>$_POST["listaMetodoPago"],
							 "tipo_pago"=>$_POST["listaTipoPago"],
							 "fechaVencimineto"=>$fechaFormateada);
